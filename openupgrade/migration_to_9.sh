...
odoouninstall.py -d v8-sinfocom-full --user admin --password Miky969696 res_users_clear_access_rights
odoouninstall.py -d v8-sinfocom-full --user admin --password Miky969696 module is_employee
...
odoouninstall.py -d v8-sinfocom-full --user admin --password Miky969696 module mail_delete_sent_by_footer
