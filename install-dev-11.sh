...
su - odoo -c "/opt/odoo/server/odoo-bin --stop-after-init -s -c /opt/odoo/odoo.conf --db_host=localhost --db_user=odoo --db_password=odoo --addons-path=/opt/odoo/server/odoo/addons,/opt/odoo/server/addons,/opt/odoo/addons"
...
pip3 install -r /opt/odoo/source/ingadhoc/aeroo_reports/requirements.txt
...
su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/miscellaneous  /opt/odoo/source/ingadhoc/miscellaneous"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/miscellaneous/base_ux /opt/odoo/addons/base_ux"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/miscellaneous/base_validator /opt/odoo/addons/base_validator"


su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/odoo-argentina  /opt/odoo/source/ingadhoc/odoo-argentina"
pip3 install -r /opt/odoo/source/ingadhoc/odoo-argentina/requirements.txt
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_account /opt/odoo/addons/l10n_ar_account"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_account_vat_ledger /opt/odoo/addons/l10n_ar_account_vat_ledger"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_account_vat_ledger_citi /opt/odoo/addons/l10n_ar_account_vat_ledger_citi"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_account_withholding /opt/odoo/addons/l10n_ar_account_withholding"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_afipws /opt/odoo/addons/l10n_ar_afipws"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_afipws_fe /opt/odoo/addons/l10n_ar_afipws_fe"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_bank /opt/odoo/addons/l10n_ar_bank"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_base /opt/odoo/addons/l10n_ar_base"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_chart /opt/odoo/addons/l10n_ar_chart"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_currency_update /opt/odoo/addons/l10n_ar_currency_update"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_demo /opt/odoo/addons/l10n_ar_demo"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/odoo-argentina/l10n_ar_partner /opt/odoo/addons/l10n_ar_partner"

su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/argentina-sale  /opt/odoo/source/ingadhoc/argentina-sale"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-sale/l10n_ar_sale /opt/odoo/addons/l10n_ar_sale"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-sale/l10n_ar_stock /opt/odoo/addons/l10n_ar_stock"

su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/argentina-reporting  /opt/odoo/source/ingadhoc/argentina-reporting"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_base /opt/odoo/addons/l10n_ar_aeroo_base"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_einvoice /opt/odoo/addons/l10n_ar_aeroo_einvoice"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_invoice /opt/odoo/addons/l10n_ar_aeroo_invoice"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_payment_group /opt/odoo/addons/l10n_ar_aeroo_payment_group"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_purchase /opt/odoo/addons/l10n_ar_aeroo_purchase"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_sale /opt/odoo/addons/l10n_ar_aeroo_sale"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/argentina-reporting/l10n_ar_aeroo_stock /opt/odoo/addons/l10n_ar_aeroo_stock"

su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/account-financial-tools  /opt/odoo/source/ingadhoc/account-financial-tools"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_debt_management /opt/odoo/addons/account_debt_management"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_document /opt/odoo/addons/account_document"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_financial_amount /opt/odoo/addons/account_financial_amount"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_fix /opt/odoo/addons/account_fix"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_interests /opt/odoo/addons/account_interests"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_journal_security /opt/odoo/addons/account_journal_security"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_move_helper /opt/odoo/addons/account_move_helper"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_statement_aeroo_report /opt/odoo/addons/account_statement_aeroo_report"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_statement_move_import /opt/odoo/addons/account_statement_move_import"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-financial-tools/account_ux /opt/odoo/addons/account_ux"
...
su - odoo -c "git clone -b 11.0 --single-branch https://github.com/ingadhoc/account-payment  /opt/odoo/source/ingadhoc/account-payment"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_check /opt/odoo/addons/account_check"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_payment_fix /opt/odoo/addons/account_payment_fix"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_payment_group /opt/odoo/addons/account_payment_group"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_payment_group_document /opt/odoo/addons/account_payment_group_document"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_transfer_unreconcile /opt/odoo/addons/account_transfer_unreconcile"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_withholding /opt/odoo/addons/account_withholding"
su - odoo -c "ln -sfn /opt/odoo/source/ingadhoc/account-payment/account_withholding_automatic /opt/odoo/addons/account_withholding_automatic"
