...
su - odoo -c "git clone -b 9.0 --single-branch https://github.com/OCA/OCB.git /opt/odoo/server"
su - odoo -c "mkdir -p /opt/odoo/source/OCA"
su - odoo -c "git clone -b 9.0 https://github.com/OCA/webkit-tools /opt/odoo/source/OCA/webkit-tools"
...
su - odoo -c "git clone -b 9.0 https://github.com/OCA/reporting-engine /opt/odoo/source/OCA/reporting-engine"
...
wget https://raw.githubusercontent.com/fcoach66/odoo-install/master/odoo9.init.d -O /etc/init.d/odoo-server
...
su - odoo -c "mkdir -p /opt/odoo/source/OCA"
su - odoo -c "git clone -b 9.0 https://github.com/OCA/l10n-italy /opt/odoo/source/OCA/l10n-italy"
