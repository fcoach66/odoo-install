...
/usr/bin/pip3 install --upgrade -r https://raw.githubusercontent.com/odoo/odoo/11.0/requirements.txt
...
/usr/bin/pip3 install num2words ofxparse
...
/etc/init.d/office
/usr/bin/pip3 install jsonrpc2 daemonize
...
/usr/bin/pip3 install --upgrade -r /home/odoo/odoodev11/source/3-ingadhoc/aeroo_reports/requirements.txt
su - odoo -c "git clone -b 11.0 --single-branch https://github.com/OCA/server-tools  /home/odoo/odoodev11/source/2-OCA/server-tools"
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/server-tools/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/odoo-argentina/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/sale/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/account-financial-reporting/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/stock-logistics-barcode/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/web/requirements.txt
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/report-print-send/requirements.txt 
...
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/product/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/account-invoicing/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/reporting-engine/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/partner/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/sale/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/stock-logistics-barcode/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/server-tools/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/account-financial-tools/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/web/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/account-financial-reporting/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/reporting-engine/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/report-print-send/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/5-vauxoo/addons-vauxoo/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/4-it-projects-llc/misc-addons/requirements.txt
/usr/bin/pip3 install -r /home/odoo/odoodev11/source/4-it-projects-llc/website-addons/requirements.txt

/usr/bin/pip3 install email_validator



sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/server/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/4-it-projects-llc/misc-addons/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/4-it-projects-llc/website-addons/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/4-it-projects-llc/pos-addons/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/1-Yenthe666/auto_backup/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/1-rven/11.0-mig-account_fiscal_position_vat_check-account-financial-tools/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/5-vauxoo/addons-vauxoo/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/account-invoicing/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/argentina-sale/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/partner/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/account-payment/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/reporting-engine/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/odoo-argentina/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/miscellaneous/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/argentina-reporting/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/sale/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/3-ingadhoc/product/requirements.txt
sudo /usr/bin/pip3 install -U -r /home/odoo/odoodev11/source/3-ingadhoc/aeroo_reports/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/server-tools/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/reporting-engine/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/account-financial-reporting/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/report-print-send/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/community-data-files/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/stock-logistics-barcode/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/web/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/server-auth/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/connector/requirements.txt
sudo /usr/bin/pip3 install -r /home/odoo/odoodev11/source/2-OCA/account-financial-tools/requirements.txt
